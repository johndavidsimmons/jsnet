...
def Content():
    CONTENT_DICT = {
        ...
        'Resume': [
            ['Quicken Loans', 'http://www.quickenloans.com', 'August 2016 - Present', 'Analytics Developer', "Part strategist, part developer; I am responsible for maintaining Quicken Loans' web analytics tools (Adobe Analytics, Google Analytics, DTM/Launch, mParticle, Qualtrics, etc.)." ],
